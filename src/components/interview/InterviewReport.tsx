...
const reportContent: Record<Language, {
  ...
  en: {
    ...
    reportHeader: 'BUSULLA DIGJITALE - INTERVIEW PERFORMANCE REPORT',
    position: 'Position',
    duration: 'Duration',
    ...
    starAnalysis: 'STAR Method Breakdown',
    downloadReport: 'Download Report',
    retakeInterview: 'Retake Interview',
  },
  al: {
    interviewer: 'Këshillat e Intervistuesit',
    average: 'Rezultati Mesatar i Përgjithshëm',
    mode: 'Mënyra',
    ...
    reportHeader: 'BUSULLA DIGJITALE - RAPORTI I PERFORMANCËS SË INTERVISTËS',
    position: 'Pozicioni',
    ...
    date: 'Data',
    title: 'Raporti i Performancës së Intervistës',
    questionsAnswered: 'Pyetjet e Përgjigjura',
    strengths: 'Pikat e Forta',
    improvements: 'Fushat për Përmirësim',
    starAnalysis: 'Analiza e Metodës STAR',
    downloadReport: 'Shkarko Raportin',
    retakeInterview: 'Rijep Intervistën',
  },
};
